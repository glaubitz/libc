...
pub const SYS_getpmsg: ::c_long = 188; /* some people actually want streams */
pub const SYS_putpmsg: ::c_long = 189; /* some people actually want streams */
pub const SYS_vfork: ::c_long = 190;
pub const SYS_ugetrlimit: ::c_long = 191; /* SuS compliant getrlimit */
...
pub const SYS_epool_wait: ::c_long = 251;
...
pub const SYS_vserver: ::c_long = 278;
